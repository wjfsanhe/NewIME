...
class SpellingTrie {
 private:
  ...
  static const IME_SIZE_T kValidSplCharNum = 26;
  ...
  IME_SIZE_T spelling_size_;

  // Number of full spelling ids.
  IME_SIZE_T spelling_num_;
  ...
  char *ym_buf_;
  IME_SIZE_T ym_size_;  // The size of longest Yunmu string, '\0'included.
  IME_SIZE_T ym_num_;
  ...
  SpellingNode* construct_spellings_subset(IME_SIZE_T item_start, IME_SIZE_T item_end,
                                           IME_SIZE_T level, SpellingNode *parent);
  bool build_f2h();
 ...
 public:
  ...
  bool construct(const char* spelling_arr, IME_SIZE_T item_size, IME_SIZE_T item_num,
  ...
  IME_SIZE_T get_spelling_str16(uint16 splid, char16 *splstr16,
