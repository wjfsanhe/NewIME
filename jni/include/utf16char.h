...
extern "C" {
  ...
  char16* utf16_strtok(char16 *utf16_str, IME_SIZE_T *token_size,
  ...
  IME_SIZE_T utf16_strlen(const char16 *utf16_str);

  int utf16_strcmp(const char16 *str1, const char16 *str2);
  int utf16_strncmp(const char16 *str1, const char16 *str2, IME_SIZE_T size);

  char16* utf16_strcpy(char16 *dst, const char16 *src);
  char16* utf16_strncpy(char16 *dst, const char16 *src, IME_SIZE_T size);
