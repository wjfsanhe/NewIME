...
class AtomDictBase {
 public:
   ...
   */
  virtual IME_SIZE_T number_of_lemmas() = 0;
  ...
  virtual MileStoneHandle extend_dict(MileStoneHandle from_handle,
                                      ...
                                      IME_SIZE_T lpi_max, IME_SIZE_T *lpi_num) = 0;
   ...
   */
  virtual IME_SIZE_T get_lpis(const uint16 *splid_str, uint16 splid_str_len,
                          LmaPsbItem *lpi_items, IME_SIZE_T lpi_max) = 0;
   ...
   */
  virtual IME_SIZE_T predict(const char16 last_hzs[], uint16 hzs_len,
                         NPredictItem *npre_items, IME_SIZE_T npre_max,
                         IME_SIZE_T b4_used) = 0;
   ...
   */
  virtual IME_SIZE_T get_total_lemma_count() = 0;
   ...
   */
  virtual void set_total_lemma_count_of_others(IME_SIZE_T count) = 0;
