...
static const IME_SIZE_T kCodeBookSize = 256;
...
class NGram {
 public:
  ...
  static const IME_SIZE_T kSysDictTotalFreq = 100000000;
 ...
 private:
  ...
  IME_SIZE_T total_freq_none_sys_;
 ...
 public:
  ...
  void set_total_freq_none_sys(IME_SIZE_T freq_none_sys);
  ...
  bool build_unigram(LemmaEntry *lemma_arr, IME_SIZE_T num,
