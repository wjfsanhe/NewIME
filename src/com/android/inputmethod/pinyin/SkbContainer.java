...
public class SkbContainer extends RelativeLayout implements OnTouchListener {
    ...
    private static String TAG = "SkbContainer";
    ...
    public boolean notifyKeyDown(int keyCode, KeyEvent event) {
       if(null != mMajorView) {
            ...
            if(keyCode == KeyEvent.KEYCODE_BUTTON_THUMBL || keyCode == KeyEvent.KEYCODE_BUTTON_A){
                ...
                mDiscardEvent = false;
                int x,y ;
                x = mMajorView.getCurrentFocusAxis().x;
                y = mMajorView.getCurrentFocusAxis().y;
    
                mSkv = null;
                mSoftKeyDown = null;
                mSkv = mMajorView ;//inKeyboardView(x, y, mSkvPosInContainer);
                if (null != mSkv) {
            ...
            return mMajorView.receiveKeyDown(keyCode,event);
    ...
    public boolean notifyKeyUp(int keyCode, KeyEvent event) {
       if(null != mMajorView) {
            ...
            return mMajorView.receiveKeyUp(keyCode,event);
       } 
       return false ;
    }
