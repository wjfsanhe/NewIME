...
public class CandidateView extends View {
    ...
    private void onSizeChanged() {
        ...
        mContentHeight = (int) ((getMeasuredHeight() - mPaddingTop - mPaddingBottom) * 0.65f);
        /**
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mDecInfo.isStartWithIUV()){
            pSize = 1;
            mDecInfo.mCandidatesList.add(mDecInfo.getComposingStrActivePart().toUpperCase());
        }
